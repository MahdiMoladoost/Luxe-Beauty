...
function HeroWave() {
  return (
    <svg
      ...
      className="block h-[64px] w-full sm:h-[78px] lg:h-[88px]"
...
export function BookingHero() {
  ...
  return (
    <div className="relative bg-background pb-[245px] sm:pb-[210px] lg:pb-[155px]">
      <section className="relative isolate h-[400px] overflow-visible sm:h-[440px] lg:h-[480px]">
        <div
          className="absolute inset-0 -z-20 bg-cover bg-[position:center_38%] sm:bg-[position:center_40%] lg:bg-[position:center_42%]"
          style={{ backgroundImage: "url('/hero.png')" }}
          aria-hidden="true"
        />

        <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-4 pb-20 pt-8 sm:px-6 sm:pb-24 lg:px-8 lg:pb-28">
          <h1
            dir="rtl"
            className="ml-auto w-full max-w-[560px] text-right font-sans text-[1.75rem] font-bold leading-[1.55] tracking-[-0.025em] text-[#382522] sm:text-[2.15rem] sm:leading-[1.5] lg:text-[2.55rem] lg:leading-[1.45]"
          >
            <span className="block">بهترین سالن‌ها و متخصصان زیبایی را پیدا کن</span>
            <span className="block">و آنلاین نوبت بگیر</span>
          </h1>
        </div>

        <div className="pointer-events-none absolute inset-x-0 bottom-[-2px] z-0 leading-none">
          <HeroWave />
        </div>

        <div className="absolute inset-x-0 bottom-0 z-20 translate-y-[46%] px-4 sm:px-6 lg:px-8">
          <form
            onSubmit={submitSearch}
            className="mx-auto max-w-6xl rounded-[30px] border border-[#ead7d0] bg-white p-3 shadow-[0_24px_70px_rgba(97,57,46,0.16)] sm:p-4"
          >
            <div className="hidden gap-3 md:grid md:grid-cols-3">
              <FieldShell>
                <label className="flex items-start gap-3">
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-[11px] font-bold text-[#81584d]">چه خدمتی؟</span>
                    <input
                      value={service}
              ...
              <FieldShell>
                <label className="flex items-start gap-3">
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-[11px] font-bold text-[#81584d]">کجا؟</span>
                    <input
                      value={location}
              ...
              <FieldShell>
                <div className="flex items-start gap-3">
                  ...
                  <span className="min-w-0 flex-1">
                    <span className="block text-[11px] font-bold text-[#81584d]">چه زمانی؟</span>
                    <div className="mt-1 flex items-center gap-2">
                      <select
                        value={dateMode}
                        onChange={(event) => setDateMode(event.target.value)}
                        className="min-w-0 flex-1 bg-transparent text-sm font-semibold text-[#2f2522] outline-none"
                      >
                      ...
                      <select
                        ...
                        className="w-20 bg-transparent text-xs font-medium text-[#6e5550] outline-none"
                      >
            ...
            <div className="md:hidden">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl border border-[#ead5cc] bg-white px-4 py-3 text-sm font-semibold text-[#7d594f]"
                    >
              ...
              {mobileStep === 3 && (
                <div className="space-y-3">
                  <FieldShell>
                    <span className="mb-2 block text-[11px] font-bold text-[#81584d]">چه زمانی؟</span>
                    <select
                      value={dateMode}
                      onChange={(event) => setDateMode(event.target.value)}
                      className="w-full bg-transparent text-sm font-semibold text-[#2f2522] outline-none"
                    >
                      <option value="first-available">اولین نوبت خالی</option>
                      <option value="today">امروز</option>
                      <option value="tomorrow">فردا</option>
                  ...
                  <FieldShell>
                    <span className="mb-2 block text-[11px] font-bold text-[#81584d]">صبح، ظهر یا عصر</span>
                    <select
                      value={dayPart}
                      onChange={(event) => setDayPart(event.target.value)}
                      className="w-full bg-transparent text-sm font-semibold text-[#2f2522] outline-none"
              ...
              <div className="mt-3 flex gap-2">
                {mobileStep > 1 && (
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-2xl border border-[#ead5cc] bg-white px-4 py-3 text-sm font-semibold text-[#7d594f]"
                  >
                ...
                {mobileStep < 3 ? (
                  <button
                    ...
                    className="inline-flex flex-1 items-center justify-center rounded-2xl bg-[#ae6655] px-5 py-3 text-sm font-bold text-white shadow-[0_12px_30px_rgba(174,102,85,0.28)]"
                  >
                    مرحله بعد
                  </button>
                ) : (
                  <button
                    ...
                    className="inline-flex flex-1 items-center justify-center gap-2 rounded-2xl bg-[#ae6655] px-5 py-3 text-sm font-bold text-white shadow-[0_12px_30px_rgba(174,102,85,0.28)] disabled:cursor-wait disabled:opacity-70"
                  >
            ...
            <div className="mt-3 hidden items-center gap-3 md:flex">
                ...
                <FieldShell>
                  <label className="flex items-center gap-2 text-sm font-semibold text-[#6e5550]">
                    ...
                    <input
                      ...
                      className="bg-transparent text-[#2f2522] outline-none"
                    />
                  </label>
                </FieldShell>
              )}
              ...
              <button
                type="submit"
                disabled={status === "submitting"}
                className="inline-flex min-h-14 flex-1 items-center justify-center gap-2 rounded-2xl bg-[#ae6655] px-5 text-sm font-bold text-white shadow-[0_12px_30px_rgba(174,102,85,0.28)] transition hover:bg-[#985545] disabled:cursor-wait disabled:opacity-70"
              >
                {status === "submitting" && <Loader2 className="h-4 w-4 animate-spin" />}
                مشاهده نوبت‌های خالی
              </button>
              ...
              <Link
                href="/salons"
                className="inline-flex min-h-14 shrink-0 items-center justify-center rounded-2xl border border-[#e5cec5] bg-white px-5 text-sm font-bold text-[#7d594f] transition hover:bg-[#fffaf7]"
              >
                مشاهده خدمات
              </Link>
            </div>
            ...
            {dateMode === "date" && mobileStep === 3 && (
              <div className="mt-3 md:hidden">
                <FieldShell>
                  <span className="mb-2 block text-[11px] font-bold text-[#81584d]">انتخاب تاریخ</span>
                  <input
                    type="date"
                    value={customDate}
                    onChange={(event) => setCustomDate(event.target.value)}
            ...
            <div className="mt-3 rounded-2xl bg-[#fffaf7] px-4 py-2.5 text-xs leading-6 text-[#7b625a]">
              {availabilityLoading ? (
