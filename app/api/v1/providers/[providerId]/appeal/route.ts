...
import { appealProviderApplication } from "@/lib/provider/service"
...
export async function POST(
  ...
  try {
    ...
    return apiSuccess(await appealProviderApplication(principal, providerId, await request.json(), context))
  } catch (error) {
