      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-12 md:px-8 lg:px-16">
        <div className="mx-auto w-full max-w-md">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            <span className="text-xl font-black">لوکس بیوتی</span>
          </Link>

          <h1 className="mt-8 text-3xl font-bold">خوش آمدید</h1>
          <p className="mt-2 text-muted-foreground">
            برای مدیریت نوبت‌ها و علاقه‌مندی‌های خود وارد شوید
          </p>
            ...
            <TabsContent value="phone" className="mt-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={isLoading}>
                  {isLoading ? "در حال ورود..." : "دریافت کد تأیید"}
                </Button>
              </form>
            </TabsContent>
      ...
      <div className="hidden flex-1 bg-secondary lg:block">
        <div className="relative flex h-full items-center justify-center p-12">
          <div className="max-w-lg text-center">
            <h2 className="text-4xl font-bold">زیبایی، دقیقاً در زمان شما</h2>
            <p className="mt-4 text-lg text-muted-foreground">
              در لوکس بیوتی بهترین سالن‌ها و متخصصان را مقایسه کنید، نمونه‌کار ببینید و آنلاین نوبت بگیرید.
            </p>
          </div>
        </div>
      </div>
